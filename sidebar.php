...
<div class="ttr-sidebar">
		...
		<div class="ttr-sidebar-wrapper content-scroll">
			...
			<nav class="ttr-sidebar-navi">
				<ul>
					<li>
						<a href="myaccount.php" class="ttr-material-button">
					...
					<li>
						<a href="#" class="ttr-material-button">
							...
							<span class="ttr-label">Forums</span>
					...
					<li>
						<a href="mypost.php" class="ttr-material-button">
					...
					<li>
						<a href="#" class="ttr-material-button">
							<span class="ttr-icon"><i class="ti-calendar"></i></span>
							<span class="ttr-label">Affiliate with Us</span>
