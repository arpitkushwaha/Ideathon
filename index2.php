...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<h3 class="myf-text mt-2 mb-3">MY FURRIES</h3>
			    				
			<h1 id="cspio-headline">Coming Soon</h1>			    				
			
			<div id="cspio-description">Pet's wellness and happiness hub</div>	
				<form id="cspio-form" action="" method="post">
				<div id="cspio-field-wrapper">
					<div class="row justify-content-center mb-4">
						<div class="col-md-10 seperate"><div class="input-group"><input id="cspio-email" name="EMAIL" class="form-control input-lg form-el input-size" type="email" placeholder="Email" required/>
					<span class="input-group-btn"><button id="cspio-subscribe-btn" type="submit" class="btn btn-lg btn-primary form-el noglow new-btn">Subscribe to newsletter</button></span></div></div>
					</div>
				</div>
			</form>		  
			
			<div id="cspio-description">Follow Us</div>	
				    			    								    			    			    				
			<div id="cspio-socialprofiles">
				<a href="" target="_blank"><i class="fa fa-facebook-official fa-2x"></i></a>			
				<a href="" target="_blank"><i class="fa fa-twitter fa-2x"></i></a>
				<a href="" target="_blank"><i class="fa fa-instagram fa-2x"></i></a>			
				<a href="mailto:site@myfurries.com" target="_blank"><i class="fa fa-envelope fa-2x"></i></a>			
			</div>
...
{
	font-family: 'Montserrat', sans-serif;
    /* src: url(oldassets/fonts/Introhead/IntroRust-Base.otf); */
}
</style>