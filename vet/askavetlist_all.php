								...
								<div class="blog-post blog-md clearfix">
									...
									<div class="ttr-post-info forum-list-box-width">
										<form action="dashboard_vet.php" method="POST">
											...
											<button name="readmore" type="submit" class="title-forum-btn text-left">
												<a>
									...
									{
										echo '<span class="askavet-list-badge" >
										<span class="label label-success arrowed-in text-white">Open</span>
										</span>';
									}
									else
									{
										echo '<span class="askavet-list-badge">
										<span class="label label-important arrowed-in text-white">Closed</span>
										</span>';
									}
...
<!-- 
										...
										<div class="card-courses-list-bx   card-courses-list-bx-margin ">
											<div class="row author-margin">
												<div class="col-sm-12 ml-2 mt-1  text-muted 	forum-list-box-font-size">
													...
													<span>Rohan Mujoo</span> | <span>May 2020</span>
												</div>
											...
											<div class="row forum-list-box-info-margin">
												<div class="col-lg-12">
													<li class="card-courses-review ml-2 mt-3" style="float: left;">
														<div class="media-box">
															<ul class="media-post blog-features">
																...
																<li><a href="#"><i
																			class="fa fa-thumbs-up"></i><span>54</span>
																	</a></li>
																<li><a href="#"><i
													...
													<li class="card-courses-categories m-0 mt-2	 card-courses-categories-align "
														style="float: right;">
														<h4 style="color: #FFB000;">Category</h4>
														<h5 class="category-text-margin text-muted">Pet Behaviour</h5>
													</li>
								...
								<div class="blog-post blog-md clearfix">
									...
									<div class="ttr-post-info forum-list-box-width">
										...
										<div class="card-courses-list-bx   card-courses-list-bx-margin ">
											<div class="row author-margin">
												<div class="col-sm-12 ml-2 mt-1  text-muted 
												forum-list-box-font-size">

													<span>Atul Bhardwaj</span> | <span>May 2020</span>
												</div>
										...
										<div class="search-bx style-1 mt-4">
											<a class="btn" href="logout.php"
												style="background-color: #862A30;color: #fff;width: 100%;text-transform: none;"><i
													class="fa fa-sign-out" style="color: white;"></i> Logout</a>
										</div>
