							...
							<aside class="side-bar sticky-top aside-bx" style="top: 100px;">
								<div class="widget">
									...
									<form class="search-bx style-1" action="/blogger/editblogger.php">
										<button class="btn" href="editblogger.php" style="background-color: #862A30;color: #fff;width: 100%;text-transform: none;"><i class="fa fa-newspaper-o" style="color: white;"></i> Edit Blog</button>
									</form>
								</div>
