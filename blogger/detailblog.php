...
<!-- video and img url here -->
					<?php
						...
						{
							echo '<ul class="wp-block-gallery columns-6 is-cropped mt-4 mb-4">
													...
													<li class="card-courses-review mt-2 ml-2" >
														<div class="media-box">
															<ul class="media-post blog-features share-icon-blog " >
																...
																<li><a href="http://www.facebook.com/sharer.php?u=http://myfurries.com/blogger/dashboard_blogger.php?blog_id=<?php echo $_SESSION['blog_id'] ?>" target="_blank"><i
																			class="fa fa-facebook-square"></i>
																		</a></li>
																<li><a href="whatsapp://send?text=http://myfurries.com/blogger/dashboard_blogger.php?blog_id=<?php echo $_SESSION['blog_id'] ?>" data-action="share/whatsapp/share"><i
																			class="fa fa-whatsapp"></i>
																		</a></li>
																
																<li><a href="https://www.linkedin.com/shareArticle?mini=true&
																			 url=http://myfurries.com/blogger/dashboard_blogger.php?blog_id=<?php echo $_SESSION['blog_id'] ?>&
																			 title=MyFurries&
																			 summary=Blogs&
																			 source=LinkedIn">
																			 <i class="fa fa-linkedin-square"></i>
																		</a></li>
															    <li><a href="http://twitter.com/share?text=MyFurries
																			 &url=http://myfurries.com/blogger/dashboard_blogger.php?blog_id=<?php echo $_SESSION['blog_id'] ?>
																			 &hashtags=furries,pets,animals"><i
						...
						<div class="col-md-12 col-lg-4 col-xl-4 sticky-top wow fadeInUp" >
							<aside class="side-bar sticky-top aside-bx" style="top: 100px;">
								<div class="widget">
									...
									<form class="search-bx style-1" action="editblogger.php" method="POST">
										<input type='hidden' id='custId' name='blog_id' value='<?php echo $_SESSION['blog_id']; ?>'>
										<button class="btn" name="editblog" type="submit" style="background-color: #862A30;color: #fff;width: 100%;text-transform: none;"><i class="fa fa-newspaper-o" style="color: white;"></i> Edit Blog</button>
									</form>


									<form class="search-bx style-1 mt-3" action="dashboard_blogger.php" method="POST">
										<input type='hidden' id='custId' name='blog_id' value='<?php echo $_SESSION['blog_id']; ?>'>
										<button class="btn" name="deleteblog" type="submit" style="background-color: #862A30;color: #fff;width: 100%;text-transform: none;"><i class="fa fa-trash-o" style="color: white;"></i> Delete Blog</button>
									</form>
								</div>
