			...
			<div class="row  justify-content-center">
				...
				<div class="col-lg-8 mb-5 ">
					<div class="widget-box ">
						<div class="row justify-content-center">
							<h3 class="form-head-mypost mt-4" style="color: rgb(100, 100, 100) ;font-weight: 600;">Create Blog</h3>
						</div>
								...
								<form method="POST" action="dashboard_blogger.php" enctype="multipart/form-data" class="mail-compose">
									...
									<div class="form-group col-lg-12">
										...
										<input id="exampleFormControlText1" class="form-control" name="description" type="text"
											placeholder="Write small description here for your blog" required>
									</div>
									<div class="form-group col-lg-12">
									...
									<div class="form-group row   ">
										...
										<div class="col-sm-12 mt-3  ml-3 category-align">
											...
											<div  class="text-center">
												...
												<div class="file-upload">
													<div class="file-select" style="border-radius: 5px;">
													  ...
													  <input type="file" name="fileToUpload"   id="fileToUpload" accept="image/*" width="100%" >
													</div>
												  </div>
