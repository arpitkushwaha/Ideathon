<?php
	...
	//Check Session
	if(empty($_SESSION['blogger']) && empty($_SESSION['category_id_filter']))
	{
...
<?php 
				$user_fk = $_SESSION['id'];
				$category_fk = $_SESSION['category_id_filter'];
				$sql_e = "SELECT * FROM blog_post WHERE user_fk='$user_fk' AND category_fk='$category_fk' ORDER BY created_at DESC"  ;
											...
											<div class="row">
												<div class="col-lg-12">
													...
													<div class="post-extra row public-blog-read-btn  "
														...
														<form class="padding-btn" action="dashboard_blogger.php" method="POST" >
						...
						<div class="col-md-12 col-lg-4 col-xl-4 sticky-top wow fadeInUp" >
							<aside class="side-bar sticky-top aside-bx">
								...
								<div class=" widget  " >
									...
									<li class="list-category"><div><a href="userbloglist_all.php" class="category-blog"><i class="fa fa-angle-right"></i>All</a></div></li> <hr>
									<?php
										$sql_e = "SELECT * FROM blog_categories";
										$result_blog_categories = $conn->query($sql_e);
										...
										echo '
										<form id="category_'.$category_id.'" action="dashboard_blogger.php" method="POST">
											<li onclick="category_'.$category_id.'.submit();" class="list-category"><div><a href="#" class="category-blog"><i class="fa fa-angle-right"></i>'.$category_name.'</a></div></li> <hr>
											<input type="hidden" name="category_id_filter" value="'.$category_id.'">
										</form>		';
											}
										}
									?>
