...
<main class="ttr-wrapper" id="create_blog" >
			...
			<div class="row  justify-content-center">
				...
				<div class="col-lg-11 mb-5 ">
					<div class="widget-box shadow-lg">
						<div class="row justify-content-center">
							<h3 class="form-head-mypost">Ask a Vet</h3>
						</div>
						<div class="email-wrapper">

							<div class="mail-list-container">
								<form method="POST" action="createblog.php" enctype="multipart/form-data" class="mail-compose">
									...
									<div class="form-group col-lg-12">
										...
										<textarea class="form-control rounded-0" name="content" id="exampleFormControlTextarea1"
											rows="50" placeholder="Hello world!"></textarea>
									</div>
									...
									<div class="form-group">
										<label for="tagPlaces" class="col-sm-2 control-label title-head">Choose 
											Tag</label>
										<div class="col-sm-12">
										    <select name="tags" class="form-control select2 tag-input-form" multiple="multiple" style="width: 100%;"></select>
										</div>
									</div>
									<div class="form-group row   ">

										<div class="col-sm-12 pr-5 ml-3">
