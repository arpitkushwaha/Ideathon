...
if(isset($_POST['submit'])){
	...
	$sql = "INSERT INTO contactus(email, name, message) VALUES ('$email','$name','$message')" ;
...
<head>
	...
	<link rel="shortcut icon" href="coming/logo.jpg">
	...
	html{
		height:100%;
		background:linear-gradient(130deg,rgba(95, 95, 95, 0.486) 0%,rgba(0, 0, 0, 0.404) 90%),url(coming/13.jpeg);
...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<img id="cspio-logo" src="coming/logo.jpg" style="width: 20%;">

			<h3 class="myf-text mt-2 mb-3">Contact Us</h3>
			    				
			<form action="contactus.php" method="POST">
                <div class="form-group row justify-content-center ">
                    <div class="col-md-5">
                        <label for="my-input" class="float-left">First name</label>
                    <input id="my-input" class="form-control" type="text" name="first_name" placeholder="eg: John">
                    </div>
                    <div class="col-md-5">
                        <label for="my-input" class="float-left">Last name</label>
                    <input id="my-input" class="form-control" type="text" name="last_name" placeholder="eg: smith">
                    </div>
                    
                </div>
                <div class="form-group row justify-content-center ">
                    <div class="col-md-10">
                        <label for="my-input" class="float-left">Email</label>
                    <input id="my-input" class="form-control" type="text" name="email" placeholder="abc@xyz.com">
                    </div>
                ...
                <div class="form-group row justify-content-center ">
                    <div class="col-md-10">
                        <label for="my-input" class="float-left">Message</label>
                    <textarea class="form-control" name="message" id="" cols="30" rows="3" placeholder="Write your message in less than 250 words"></textarea>
                    </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <button type="submit" name="submit" class="form-control send-btn">Send</button>
                    </div>
                </div>
                ...
                <div class="col-lg-10 mt-4">
                    <a href="index.php">
                        <i class="fa fa-arrow-circle-left  ">
                            <span class="back-btn">Go Back</span>
