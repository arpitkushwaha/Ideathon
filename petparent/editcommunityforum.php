        ...
        <div class="page-banner page-banner-sm">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="banner-head">Edit Forum</h1>
                        ...
                        <div class="mail-list-container">
                            <form method="POST" action="dashboard_blogger.php" enctype="multipart/form-data" class="mail-compose">
                                <div class="form-group col-12">
                                    ...
                                    <input  class="form-control" type="text" placeholder="Heading" name="title" title="Special symbols like ^;():/\,><'z'or“z” are not valid  "  pattern="[^()/><'\][\\\x22,;|]+" required>
                                </div>

                                
                                <div class="form-group col-lg-12">
                                    <label for="exampleFormControlTextarea1" class="title-head">Content</label>
                                    <textarea class="form-control rounded-0" name="content" id="exampleFormControlTextarea1" title="Special symbols like ^;():/\,><'z'or“z” are not valid  " pattern="[^()/><'\][\\\x22,;|]+" required
