        ...
        <div class="page-banner page-banner-sm">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="banner-head">Edit Ask a Vet</h1>
        ...
        <div class="row  justify-content-center">
            ...
            <div class="col-lg-8 mb-5 ">
                <div class="widget-box ">
                    <div class="row justify-content-center">
                        <h3 class="form-head-mypost" style="color: rgb(100, 100, 100) ;font-weight: 600;">Enter Details</h3>
                    </div>
                    <div class="email-wrapper">

                        <div class="mail-list-container">
                            <form method="POST" action="editaskavet.php" enctype="multipart/form-data" class="mail-compose">
                                <div class="form-group col-12">
                                    <label  class="title-head">Title</label>
                                    <input  class="form-control" type="text" value="<?php echo $_SESSION['askavet_edit_title']; ?>" placeholder="Heading" name="title" title="Special symbols like ^;():/\,><'z'or“z” are not valid  " pattern="[^()/><'\][\\\x22,;|]+" required >
                                </div>

                                
                                <div class="form-group col-lg-12">
                                    <label for="exampleFormControlTextarea1" class="title-head">Content</label>
                                    <textarea class="form-control rounded-0" name="content" id="exampleFormControlTextarea1"  pattern="[^()/><'\][\\\x22,;|]+" required
                                        rows="5" title="Special symbols like ^;():/\,><'z'or“z” are not valid  " placeholder="Hello world!"><?php echo $_SESSION['askavet_edit_content']; ?></textarea>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input  class="form-control" type="url" value="<?php echo $_SESSION['askavet_edit_video']; ?>" name="video">
                                </div>
                                    ...
                                    <!-- <form method='post' action='upload.php' enctype='multipart/form-data' > -->
                                      ...
                                      <div class="text-center">
                                        ...
                                        <div class="file-upload">
                                            ...
                                            <button name="editaskavet" type="submit" class="btn btn-lg mt-5 r-5 blog-send-btn">Submit</button>	
                                          </div>
                                </form>
                                </div>
                        </div>
